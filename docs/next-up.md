...
- AvQest font: bundled in `public/fonts/AvQest.ttf` under GemFonts' freeware distribution ([Fontspace listing](https://www.fontspace.com/avqest-font-f4004)). Author/foundry credit in the footer is **GemFonts** (Graham Meade's outfit, 1998). Don't add a "download font" link in the UI — redirecting users to a font download from inside the editor isn't the editor's job.
